...
def main():
    ...
    def episode_finished(r):
        if r.episode % report_episodes == 0:
            ...
            mean500 = np.mean(r.episode_rewards[-500:])
            logger.info("Average of last 500 rewards: {}".format(mean500))
            mean100 = np.mean(r.episode_rewards[-100:])
            logger.info("Average of last 100 rewards: {}".format(mean100))
